...
public class IService_Account_Service_Impl implements IService_Account_Service {
	...
	private Service_Account_Mapper service_Account_Mapper;
	
	@Autowired
	public IService_Account_Service_Impl(IService_Account_DAO iService_Account_DAO, Service_Account_Mapper service_Account_Mapper) {
